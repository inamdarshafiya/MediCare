...
export class BookComponent implements OnInit {
  ...
  constructor(private activatedRoute: ActivatedRoute, private formBuilder: FormBuilder,public http:HttpClient,private router: Router,private appointmentService:ViewAppointmentsService) {
